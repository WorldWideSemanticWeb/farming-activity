...
enyo.kind({
	...
	this.$.appList.setCount(deer.length);
    },
    setupItem: function(inSender,inEvent) {
       ...
       //within the closure.
       this.crop = deer[inEvent.index].crop;
       this.disease = deer[inEvent.index].disease;
       this.id = deer[inEvent.index].identification;
       this.management = deer[inEvent.index].management;
       this.photos = deer[inEvent.index].src;
