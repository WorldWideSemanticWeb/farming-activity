...
enyo.kind({
	...
	this.$.appList.setCount(pigs.length);
    },
    setupItem: function(inSender,inEvent) {
       ...
       //within the closure.
       this.crop = pigs[inEvent.index].crop;
       this.disease = pigs[inEvent.index].disease;
       this.id = pigs[inEvent.index].identification;
       this.management = pigs[inEvent.index].management;
       this.photos = pigs[inEvent.index].src;
