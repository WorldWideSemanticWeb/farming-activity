...
enyo.kind({
	...
	this.$.appList.setCount(guineapig.length);
    },
    setupItem: function(inSender,inEvent) {
       ...
       //within the closure.
       this.crop = guineapig[inEvent.index].crop;
       this.disease = guineapig[inEvent.index].disease;
       this.id = guineapig[inEvent.index].identification;
       this.management = guineapig[inEvent.index].management;
       this.photos = guineapig[inEvent.index].src;
