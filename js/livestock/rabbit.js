...
enyo.kind({
	...
	this.$.appList.setCount(rabbit.length);
    },
    setupItem: function(inSender,inEvent) {
       ...
       //within the closure.
       this.crop = rabbit[inEvent.index].crop;
       this.disease = rabbit[inEvent.index].disease;
       this.id = rabbit[inEvent.index].identification;
       this.management = rabbit[inEvent.index].management;
       this.photos = rabbit[inEvent.index].src;
