...
enyo.kind({
	...
	this.$.appList.setCount(buffalo.length);
    },
    setupItem: function(inSender,inEvent) {
       ...
       //within the closure.
       this.crop = buffalo[inEvent.index].crop;
       this.disease = buffalo[inEvent.index].disease;
       this.id = buffalo[inEvent.index].identification;
       this.management = buffalo[inEvent.index].management;
       this.photos = buffalo[inEvent.index].src;
