...
enyo.kind({
	...
	this.$.appList.setCount(horses.length);
    },
    setupItem: function(inSender,inEvent) {
       ...
       //within the closure.
       this.crop = horses[inEvent.index].crop;
       this.disease = horses[inEvent.index].disease;
       this.id = horses[inEvent.index].identification;
       this.management = horses[inEvent.index].management;
       this.photos = horses[inEvent.index].src;
