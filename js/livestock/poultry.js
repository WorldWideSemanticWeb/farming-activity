...
enyo.kind({
	...
	this.$.appList.setCount(poultry.length);
    },
    setupItem: function(inSender,inEvent) {
       ...
       //within the closure.
       this.crop = poultry[inEvent.index].crop;
       this.disease = poultry[inEvent.index].disease;
       this.id = poultry[inEvent.index].identification;
       this.management = poultry[inEvent.index].management;
       this.photos = poultry[inEvent.index].src;
