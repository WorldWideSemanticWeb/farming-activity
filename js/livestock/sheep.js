...
enyo.kind({
	...
	this.$.appList.setCount(sheep.length);
    },
    setupItem: function(inSender,inEvent) {
       ...
       //within the closure.
       this.crop = sheep[inEvent.index].crop;
       this.disease = sheep[inEvent.index].disease;
       this.id = sheep[inEvent.index].identification;
       this.management = sheep[inEvent.index].management;
       this.photos = sheep[inEvent.index].src;
