...
enyo.kind({
	...
	this.$.appList.setCount(goats.length);
    },
    setupItem: function(inSender,inEvent) {
       ...
       //within the closure.
       this.crop = goats[inEvent.index].crop;
       this.disease = goats[inEvent.index].disease;
       this.id = goats[inEvent.index].identification;
       this.management = goats[inEvent.index].management;
       this.photos = goats[inEvent.index].src;
