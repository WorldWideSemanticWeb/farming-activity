...
enyo.kind({
	...
	this.$.appList.setCount(rice.length);
    },
    setupItem: function(inSender,inEvent) {
       ...
       //within the closure.
       this.crop = rice[inEvent.index].crop;
       this.disease = rice[inEvent.index].disease;
       this.id = rice[inEvent.index].identification;
       this.management = rice[inEvent.index].management;
       this.photos = rice[inEvent.index].src;
