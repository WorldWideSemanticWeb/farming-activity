...
enyo.kind({
	...
	this.$.appList.setCount(wheat.length);
    },
    setupItem: function(inSender,inEvent) {
       ...
       //within the closure.
       this.crop = wheat[inEvent.index].crop;
       this.disease = wheat[inEvent.index].disease;
       this.id = wheat[inEvent.index].identification;
       this.management = wheat[inEvent.index].management;
       this.photos = wheat[inEvent.index].src;
