...
enyo.kind({
	...
	this.$.appList.setCount(cassava.length);
    },
    setupItem: function(inSender,inEvent) {
       ...
       //within the closure.
       this.crop = cassava[inEvent.index].crop;
       this.disease = cassava[inEvent.index].disease;
       this.id = cassava[inEvent.index].identification;
       this.management = cassava[inEvent.index].management;
       this.photos = cassava[inEvent.index].src;
