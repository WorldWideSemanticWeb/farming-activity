...
enyo.kind({
	...
	this.$.appList.setCount(yam.length);
    },
    setupItem: function(inSender,inEvent) {
       ...
       //within the closure.
       this.crop = yam[inEvent.index].crop;
       this.disease = yam[inEvent.index].disease;
       this.id = yam[inEvent.index].identification;
       this.management = yam[inEvent.index].management;
       this.photos = yam[inEvent.index].src;
