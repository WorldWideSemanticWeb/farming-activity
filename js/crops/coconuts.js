...
enyo.kind({
	...
	this.$.appList.setCount(coconut.length);
    },
    setupItem: function(inSender,inEvent) {
       ...
       //within the closure.
       this.crop = coconut[inEvent.index].crop;
       this.disease = coconut[inEvent.index].disease;
       this.id = coconut[inEvent.index].identification;
       this.management = coconut[inEvent.index].management;
       this.photos = coconut[inEvent.index].src;
