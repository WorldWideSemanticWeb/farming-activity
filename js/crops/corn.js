...
enyo.kind({
	...
	this.$.appList.setCount(corn.length);
    },
    setupItem: function(inSender,inEvent) {
       ...
       //within the closure.
       this.crop = corn[inEvent.index].crop;
       this.disease = corn[inEvent.index].disease;
       this.id = corn[inEvent.index].identification;
       this.management = corn[inEvent.index].management;
       this.photos = corn[inEvent.index].src;
