...
enyo.kind({
	...
	this.$.appList.setCount(soybean.length);
    },
    setupItem: function(inSender,inEvent) {
       ...
       //within the closure.
       this.crop = soybean[inEvent.index].crop;
       this.disease = soybean[inEvent.index].disease;
       this.id = soybean[inEvent.index].identification;
       this.management = soybean[inEvent.index].management;
       this.photos = soybean[inEvent.index].src;
