...
enyo.kind({
	...
	this.$.appList.setCount(potatoes.length);
    },
    setupItem: function(inSender,inEvent) {
       ...
       //within the closure.
       this.crop = potatoes[inEvent.index].crop;
       this.disease = potatoes[inEvent.index].disease;
       this.id = potatoes[inEvent.index].identification;
       this.management = potatoes[inEvent.index].management;
       this.photos = potatoes[inEvent.index].src;
