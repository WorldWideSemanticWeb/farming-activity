...
enyo.kind({
	...
	this.$.appList.setCount(sorghum.length);
    },
    setupItem: function(inSender,inEvent) {
       ...
       //within the closure.
       this.crop = sorghum[inEvent.index].crop;
       this.disease = sorghum[inEvent.index].disease;
       this.id = sorghum[inEvent.index].identification;
       this.management = sorghum[inEvent.index].management;
       this.photos = sorghum[inEvent.index].src;
